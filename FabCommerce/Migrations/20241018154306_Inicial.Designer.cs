...
namespace FabCommerce.Migrations
{
    ...
    [Migration("20241018154306_Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FabCommerce.Entities.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabCommerce.Entities.DetalhePedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabCommerce.Entities.ItemCarrinhoCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabCommerce.Entities.Pedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabCommerce.Entities.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabCommerce.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FabCommerce.Entities.DetalhePedido", b =>
                {
                    b.HasOne("FabCommerce.Entities.Pedido", "Pedido")
                        .WithMany("DetalhesPedido")
                        .HasForeignKey("PedidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FabCommerce.Entities.Produto", "Produto")
                        .WithMany("DetalhesPedido")
            ...
            modelBuilder.Entity("FabCommerce.Entities.ItemCarrinhoCompra", b =>
                {
                    b.HasOne("FabCommerce.Entities.Produto", null)
            ...
            modelBuilder.Entity("FabCommerce.Entities.Pedido", b =>
                {
                    b.HasOne("FabCommerce.Entities.Usuario", null)
                        .WithMany("Pedidos")
            ...
            modelBuilder.Entity("FabCommerce.Entities.Produto", b =>
                {
                    b.HasOne("FabCommerce.Entities.Categoria", null)
                        .WithMany("Produtos")
